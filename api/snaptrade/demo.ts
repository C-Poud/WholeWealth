...
export function getFreshDemoPositions(): DemoPositionItem[] {
  ...
  return [
    { symbol: "NFLX", description: "Netflix Inc.", quantity: 200, costBasis: 1085.4, assetType: "stock" },
    { symbol: "AAPL", description: "Apple Inc.", quantity: 150, costBasis: 214.8, assetType: "stock" },
    { symbol: "NVDA", description: "NVIDIA Corp.", quantity: 300, costBasis: 152.75, assetType: "stock" },
    { symbol: "TSLA", description: "Tesla Inc.", quantity: 100, costBasis: 318.2, assetType: "stock" },
    { symbol: "PLTR", description: "Palantir Technologies", quantity: 500, costBasis: 121.6, assetType: "stock" },
    { symbol: "SPY", description: "SPDR S&P 500 ETF Trust", quantity: 100, costBasis: 625.0, assetType: "etf" },
    {
      symbol: "AAPL",
