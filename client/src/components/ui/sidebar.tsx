  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-[var(--sidebar-width)] bg-transparent transition-[width] duration-100 ease-out will-change-[width]",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-[var(--sidebar-width)] transition-[left,right,width] duration-100 ease-out will-change-[width] md:flex",
          side === "left"
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-none transition-[margin,opacity] duration-500 ease-smooth focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
